...
begin
  ...
  //配列初期化
  SetLength(WaterUsage1, High(CsvData)-1, High(CsvData[0]));
  //現在列
  CurrentColumn := 0;
  ...
  //配列初期化
  SetLength(WaterUsage2, High(WaterUsage1), High(WaterUsage1[0]));
  //現在列
  CurrentColumn := 0;
  ...
  //配列初期化
  SetLength(OutputData, 27, High(CsvData[0]));
  //現在列
  CurrentColumn := 0;

  //印字用データ作成
  {部屋番号,名前,４月,５月,４～５月,金額,６月,７月,６～７月,金額,８月,９月,８～９月,金額,１０月,１１月,１０～１１月,金額,１２月,１月,１２～１月,金額,２月,３月,２～３月,金額,合計金額}
  for R := Low(CsvData[0]) to High(CsvData[0]) do
  begin
    ...
    OutputData[26,R] := OutputData[5,R]   // 4～ 5月
                      + OutputData[9,R]   // 6～ 7月
                      + OutputData[13,R]  // 8～ 9月
                      + OutputData[17,R]  //10～11月
                      + OutputData[21,R]  //12～ 1月
                      + OutputData[25,R]  // 2～ 3月
                      ;
  end;
...
const
  //Excel印字位置
  INPUT_POS: Array[0..29] of Array[0..26] of String = (
    ...
    ,('A12','B12','C12','D12','E12','F12','G12','H12','I12','J12','K12','L12','M12','N12','O12','P12','Q12','R12','S12','T12','U12','V12','W12','X12','Y12','Z12','AA12')
    ,('A13','B13','C13','D13','E13','F13','G13','H13','I13','J13','K13','L13','M13','N13','O13','P13','Q13','R13','S13','T13','U13','V13','W13','X13','Y13','Z13','AA13')
    ,('A14','B14','C14','D14','E14','F14','G14','H14','I14','J14','K14','L14','M14','N14','O14','P14','Q14','R14','S14','T14','U14','V14','W14','X14','Y14','Z14','AA14')
    ,('A15','B15','C15','D15','E15','F15','G15','H15','I15','J15','K15','L15','M15','N15','O15','P15','Q15','R15','S15','T15','U15','V15','W15','X15','Y15','Z15','AA15')
    ,('A16','B16','C16','D16','E16','F16','G16','H16','I16','J16','K16','L16','M16','N16','O16','P16','Q16','R16','S16','T16','U16','V16','W16','X16','Y16','Z16','AA16')
    ,('A17','B17','C17','D17','E17','F17','G17','H17','I17','J17','K17','L17','M17','N17','O17','P17','Q17','R17','S17','T17','U17','V17','W17','X17','Y17','Z17','AA17')
    ,('A18','B18','C18','D18','E18','F18','G18','H18','I18','J18','K18','L18','M18','N18','O18','P18','Q18','R18','S18','T18','U18','V18','W18','X18','Y18','Z18','AA18')
    ,('A19','B19','C19','D19','E19','F19','G19','H19','I19','J19','K19','L19','M19','N19','O19','P19','Q19','R19','S19','T19','U19','V19','W19','X19','Y19','Z19','AA19')
    ,('A20','B20','C20','D20','E20','F20','G20','H20','I20','J20','K20','L20','M20','N20','O20','P20','Q20','R20','S20','T20','U20','V20','W20','X20','Y20','Z20','AA20')
    ,('A21','B21','C21','D21','E21','F21','G21','H21','I21','J21','K21','L21','M21','N21','O21','P21','Q21','R21','S21','T21','U21','V21','W21','X21','Y21','Z21','AA21')
    ,('A22','B22','C22','D22','E22','F22','G22','H22','I22','J22','K22','L22','M22','N22','O22','P22','Q22','R22','S22','T22','U22','V22','W22','X22','Y22','Z22','AA22')
    ,('A23','B23','C23','D23','E23','F23','G23','H23','I23','J23','K23','L23','M23','N23','O23','P23','Q23','R23','S23','T23','U23','V23','W23','X23','Y23','Z23','AA23')
    ,('A24','B24','C24','D24','E24','F24','G24','H24','I24','J24','K24','L24','M24','N24','O24','P24','Q24','R24','S24','T24','U24','V24','W24','X24','Y24','Z24','AA24')
    ,('A25','B25','C25','D25','E25','F25','G25','H25','I25','J25','K25','L25','M25','N25','O25','P25','Q25','R25','S25','T25','U25','V25','W25','X25','Y25','Z25','AA25')
    ,('A26','B26','C26','D26','E26','F26','G26','H26','I26','J26','K26','L26','M26','N26','O26','P26','Q26','R26','S26','T26','U26','V26','W26','X26','Y26','Z26','AA26')
    ,('A27','B27','C27','D27','E27','F27','G27','H27','I27','J27','K27','L27','M27','N27','O27','P27','Q27','R27','S27','T27','U27','V27','W27','X27','Y27','Z27','AA27')
    ,('A28','B28','C28','D28','E28','F28','G28','H28','I28','J28','K28','L28','M28','N28','O28','P28','Q28','R28','S28','T28','U28','V28','W28','X28','Y28','Z28','AA28')
    ,('A29','B29','C29','D29','E29','F29','G29','H29','I29','J29','K29','L29','M29','N29','O29','P29','Q29','R29','S29','T29','U29','V29','W29','X29','Y29','Z29','AA29')
    ,('A30','B30','C30','D30','E30','F30','G30','H30','I30','J30','K30','L30','M30','N30','O30','P30','Q30','R30','S30','T30','U30','V30','W30','X30','Y30','Z30','AA30')
  );

  //ヘッダー
  Header: Array[0..26] of String = (
        '部屋番号', '名前'
      , '４月' , '５月' , '４～５月'  , '金額'
      , '６月' , '７月' , '６～７月'  , '金額'
      , '８月' , '９月' , '８～９月'  , '金額'
...
　                   + '\'
  ...
  try
    ExcelBook := ExcelApp.WorkBooks.Open(TemplateFilePath2+'.xlsx');
    try
      //1枚目のシートに保存
      ...
      try
        ...
        begin
          ...
          if (R in [0]) then
          begin
            ExcelSheet.range[INPUT_POS[0,R]].Value := lb_nengo.Text
                                          + et_year.Text
                                          + lb_nendo.Text
                                          ;
          end
          ...
          begin
            ...
            begin
              ExcelSheet.range[INPUT_POS[C,R]].Value := Header[C];
            end;
          end
          else
          //明細印字
          begin
            for C := Low(OutputData) to High(OutputData) do
            begin
              ExcelSheet.range[INPUT_POS[C,R]].Value := OutputData[C,R-2];
            end;
          end;
        end;
      finally
...
begin
  ...
  begin
    if (CsvMaster[0,i] = WaterUsage) then
    begin
